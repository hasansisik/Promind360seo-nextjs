...
const FloatingWhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-6 p-4 sm:p-3 md:p-4 rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 transition-all duration-300 z-50 hover:scale-110"
