...
const initialState: SEOState = {
  ...
  analysisSteps: [
    ...
    { progress: 56, message: 'Sayfa yükleme hızı analiz ediliyor...', status: 'pending' },
    { progress: 64, message: 'Core Web Vitals hesaplanıyor...', status: 'pending' },
    { progress: 72, message: 'Performans metrikleri ölçülüyor...', status: 'pending' },
    { progress: 80, message: 'Erişilebilirlik kontrol ediliyor...', status: 'pending' },
    { progress: 88, message: 'En İyi Uygulamalar analiz ediliyor...', status: 'pending' },
    { progress: 96, message: 'Rapor hazırlanıyor...', status: 'pending' },
    { progress: 100, message: 'Analiz tamamlandı, Rapor hazırlanıyor...', status: 'pending' }
  ],
  timestamp: null,
  analyzedUrl: null
};
...
const seoSlice = createSlice({
  ...
  reducers: {
    ...
    clearErrors: (state) => {
      state.errors = { seo: null, pageSpeed: null };
    }
  },
